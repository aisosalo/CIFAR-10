...
Evaluation has been run using the model for which the validation loss was the best (see ![`session.py`](https://github.com/aisosalo/CIFAR-10/blob/master/imageclassification/training/session.py#L152-L178)).
